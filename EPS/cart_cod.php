<?php
	...
	if(isset($_SESSION['user'])){
		...
		try{
			...
			$stmt2 = $conn->prepare("SELECT quantity FROM cart WHERE user_id =:user ");
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
                        <td><img src='".$image."' width='30px' height='30px'>1</td>
						<td>".$row['name']."</td>
						<td>&#32; ".number_format($row['price'], 2)." pesos</td>
                        ...
                        <td>&#32; ".$row2['quantity']."</td>
						<td colspan='5'>&#32; ".number_format($subtotal, 2)." pesos</td>
					</tr>
				";
				}
			}
			$output .= "
				<tr>
					...
					<td><b>&#32; ".number_format($total, 2)." pesos</b></td>
				<tr>
			";
		...
		if(count($_SESSION['cart']) != 0){
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					<tr>
						<td><img src='".$image."' width='30px' height='30px'>2</td>
						<td>".$product['name']."</td>
			...
			$output .= "
				<tr>
					...
					<td colspan='5'><b>&#32; ".number_format($total, 2)." pesos</b></td>
				<tr>
			";
		}
			...
			$output .= "
				<tr>
					<td colspan='5' align='center'>Shopping cart empty</td>
				<tr>
			";
		}
