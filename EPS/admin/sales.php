            ...
            <div class="box-header with-border">
              <div class="pull-right">
                ...
                <form method="POST" class="form-inline">
                  ...
                  <button type="submit" onclick="PrintPage()" class="btn btn-success btn-sm btn-flat" name="print"><span class="glyphicon glyphicon-print"></span> Print</button>
                </form>
              </div>
            </div>
            <div class="box-body">
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$row['pay_id']."</td>
                            <td>&#32; ".number_format($total, 2)." pesos</td>
